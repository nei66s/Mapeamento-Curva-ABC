...
export const mockIncidents: Incident[] = [
  ...
  { id: 'INC-005', itemName: 'Câmeras externas / perímetro', location: 'Loja 05 - Piracicaba', status: 'Aberto', openedAt: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString(), description: "Uma das câmeras do perímetro parou de gravar. A imagem está congelada. Necessário trocar o módulo da câmera.", lat: -22.5855, lng: -47.4153 },

  // New Incidents for Pareto
  { id: 'INC-006', itemName: 'QGBT / Quadro geral', location: 'Loja 06 - Sumaré', status: 'Resolvido', openedAt: generateDateInMonth(2025, 8).toISOString(), description: "Falha Elétrica: Curto-circuito no painel principal, desarme geral.", lat: -22.8219, lng: -47.2669 },
  { id: 'INC-007', itemName: 'Rack de compressores / unidade condensadora', location: 'Loja 07 - Hortolândia', status: 'Resolvido', openedAt: generateDateInMonth(2025, 8).toISOString(), description: "Vazamento de gás refrigerante no compressor 2.", lat: -22.8596, lng: -47.2203 },
  { id: 'INC-008', itemName: 'QGBT / Quadro geral', location: 'Loja 08 - Paulinia', status: 'Fechado', openedAt: generateDateInMonth(2025, 8).toISOString(), description: "Falha Elétrica: Superaquecimento de um barramento no QGBT.", lat: -22.7634, lng: -47.1545 },
  { id: 'INC-009', itemName: 'Forno turbo / esteira', location: 'Loja 09 - Limeira', status: 'Resolvido', openedAt: generateDateInMonth(2025, 8).toISOString(), description: "Problema Mecânico: Correia da esteira do forno rompeu.", lat: -22.5647, lng: -47.4069 },
  { id: 'INC-010', itemName: 'Evaporadores / câmaras frias', location: 'Loja 10 - Araras', status: 'Resolvido', openedAt: generateDateInMonth(2025, 8).toISOString(), description: "Formação excessiva de gelo no evaporador, bloqueando o fluxo de ar.", lat: -22.3564, lng: -47.3828 },
  { id: 'INC-011', itemName: 'Bomba de recalque / pressurização', location: 'Loja 11 - Indaiatuba', status: 'Resolvido', openedAt: generateDateInMonth(2025, 7).toISOString(), description: "Obstrução na tubulação de sucção da bomba.", lat: -23.0867, lng: -47.2183 },
  { id: 'INC-012', itemName: 'QGBT / Quadro geral', location: 'Loja 12 - Tietê', status: 'Resolvido', openedAt: generateDateInMonth(2025, 7).toISOString(), description: "Falha Elétrica: disjuntor da área de vendas desarmando intermitentemente.", lat: -23.1022, lng: -47.7153 },
  { id: 'INC-013', itemName: 'Moedor / picador / fatiador', location: 'Loja 13 - Boituva', status: 'Resolvido', openedAt: generateDateInMonth(2025, 7).toISOString(), description: "Desgaste de Peça: Lâmina do fatiador perdeu o corte.", lat: -23.2842, lng: -47.6711 },
  { id: 'INC-014', itemName: 'Rack de compressores / unidade condensadora', location: 'Loja 14 - Salto', status: 'Fechado', openedAt: generateDateInMonth(2025, 7).toISOString(), description: "Vazamento no condensador. Necessário reparo.", lat: -23.2017, lng: -47.2883 },
  { id: 'INC-015', itemName: 'Forno turbo / esteira', location: 'Loja 15 - Itu', status: 'Resolvido', openedAt: generateDateInMonth(2025, 7).toISOString(), description: "Erro Operacional: configuração incorreta de temperatura pelo operador.", lat: -23.2644, lng: -47.2992 },
  { id: 'INC-016', itemName: 'QGBT / Quadro geral', location: 'Loja 16 - Sorocaba', status: 'Resolvido', openedAt: generateDateInMonth(2025, 6).toISOString(), description: "Falha Elétrica: Contator do circuito de iluminação com defeito.", lat: -23.501, lng: -47.458 },
  { id: 'INC-017', itemName: 'QGBT / Quadro geral', location: 'Loja 17 - Valinhos', status: 'Resolvido', openedAt: generateDateInMonth(2025, 6).toISOString(), description: "Falha Elétrica: mau contato em um dos terminais de energia.", lat: -22.9711, lng: -46.9961 },
  { id: 'INC-018', itemName: 'Amassadeira / batedeira', location: 'Loja 18 - Mogi Mirim', status: 'Resolvido', openedAt: generateDateInMonth(2025, 6).toISOString(), description: "Problema Mecânico: motor da amassadeira travou por sobrecarga.", lat: -22.4319, lng: -46.9564 },
  { id: 'INC-019', itemName: 'Bomba de recalque / pressurização', location: 'Loja 01 - Americana', status: 'Resolvido', openedAt: generateDateInMonth(2025, 6).toISOString(), description: "Vazamento na gaxeta da bomba de água.", lat: -22.7532, lng: -47.3292 },
  { id: 'INC-020', itemName: 'Elevador / monta-carga', location: 'Loja 02 - Santa Bárbara', status: 'Resolvido', openedAt: generateDateInMonth(2025, 6).toISOString(), description: "Problema Mecânico: Sensor de porta desalinhado, impedindo o fechamento.", lat: -22.7391, lng: -47.4005 },
  { id: 'INC-021', itemName: 'Forno combinado / fritadeira industrial', location: 'Loja 03 - Nova Odessa', status: 'Resolvido', openedAt: generateDateInMonth(2025, 5).toISOString(), description: "Desgaste de Peça: Resistência da fritadeira queimada.", lat: -22.8013, lng: -47.2185 },
  { id: 'INC-022', itemName: 'QGBT / Quadro geral', location: 'Loja 04 - Campinas', status: 'Resolvido', openedAt: generateDateInMonth(2025, 5).toISOString(), description: "Falha Elétrica: Queda de fase no alimentador principal.", lat: -22.9068, lng: -47.0616 },
  { id: 'INC-023', itemName: 'Estruturas / revestimentos / pisos', location: 'Loja 05 - Piracicaba', status: 'Resolvido', openedAt: generateDateInMonth(2025, 5).toISOString(), description: "Obstrução: Ralo da área de vendas entupido causando alagamento.", lat: -22.5855, lng: -47.4153 },
  { id: 'INC-024', itemName: 'Rack de compressores / unidade condensadora', location: 'Loja 06 - Sumaré', status: 'Resolvido', openedAt: generateDateInMonth(2025, 5).toISOString(), description: "Vazamento no sistema de refrigeração.", lat: -22.8219, lng: -47.2669 },
  { id: 'INC-025', itemName: 'Forno turbo / esteira', location: 'Loja 07 - Hortolândia', status: 'Resolvido', openedAt: generateDateInMonth(2025, 5).toISOString(), description: "Erro Operacional: esqueceram de ligar a exaustão, disparando alarme de fumaça.", lat: -22.8596, lng: -47.2203 },
